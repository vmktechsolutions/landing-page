      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-32 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-center min-h-[calc(100vh-200px)]">
          <div className="w-full lg:w-2/3 text-center">
            ...
            {/* Floating Elements */}
            <div
              className="absolute top-1/4 left-10 bg-white/10 backdrop-blur-sm p-4 rounded-xl hidden lg:block" data-aos="fade-up" data-aos-duration="1000"
            ...
            <div
              className="absolute bottom-1/4 right-10 bg-white/10 backdrop-blur-sm p-4 rounded-xl hidden lg:block" data-aos="fade-down" data-aos-duration="1000"
            >
