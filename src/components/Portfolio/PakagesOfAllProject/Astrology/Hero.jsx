...
import banner1 from "../../../../assets/HeroSection/8df565d7e61edf39dd098517f4bb5bbf_rotated.mp4";
import banner2 from "../../../../assets/HeroSection/8df565d7e61edf39dd098517f4bb5bbf_rotated.mp4";
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-[#FAF9F6] mt-16">
      ...
      <div className="absolute inset-0">
        {/* Blur Overlay */}
        <div className="absolute inset-0 bg-orange-500/30 backdrop-blur-[1px]"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-32 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-center min-h-[calc(100vh-200px)]">
          <div className="w-full lg:w-2/3 text-center">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-6 leading-tight text-white max-w-6xl">
                AstroTech Advanced Software Solutions for Modern Astrologers
              </h1>
              <p className="text-xl text-grey-200 mb-8 max-w-6xl mx-auto">
