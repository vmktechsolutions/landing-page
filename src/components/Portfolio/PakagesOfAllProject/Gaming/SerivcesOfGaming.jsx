        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-9 ">
          {cardData.map((card) => (
            <div
              ...
              className="bg-white fade-up border border-greenColor rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 "
              style={' .fade-up{opacity: 0; transform: translateY(20px); transition: opacity 0.5s ease-out, transform 0.5s ease-out;} .fade-up.aos-animate{  opacity: 1; transform: translateY(0);}'}
            >
