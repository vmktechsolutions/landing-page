...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Left Section */}
      <div
        className="w-full lg:w-1/2 relative flex flex-col justify-center items-center lg:items-start px-4 sm:px-8 lg:px-12 py-8 lg:py-16" data-aos="fade-right" data-aos-duration="300" data-aos-easing="ease-out"
      >
        {/* Text Content Container */}
        <div className="relative w-full max-w-2xl">
          <div
            className="absolute -inset-1 bg-gradient-to-r from-white to-white blur-xl"
            data-aos="fade" data-aos-duration="2000" data-aos-easing="ease-in-out"
          />
          ...
          <div
            className="relative w-full flex justify-center lg:justify-start"
            data-aos="fade-up" data-aos-duration="300" data-aos-delay="600"
          >
            <button
            ...
            >
              ...
              <img
                className="absolute right-7 top-2/5 wiggle-effect transform -translate-y-1/2"
                src={arrow}
                alt="Arrow"
                data-aos="fade-in" data-aos-duration="1000"
              />
              ...
              {/* Button Gradient Animation */}
              <div
                className="absolute inset-0 bg-gradient-to-r marquee-effect from-blue-400/20 to-purple-400/20" data-aos="fade-in" data-aos-duration="1000"
              />
            </button>
          </div>
          ...
          {/* Decorative Elements */}
          <div
            className="absolute -z-10 top-1/2 left-1/2 gradient-animation -translate-x-1/2 -translate-y-1/2 w-[200%] aspect-square" data-aos="fade-in" data-aos-duration="1000"
      ...
      {/* Right Section */}
      <div
        className="w-full lg:w-1/2 flex justify-center items-center px-4 sm:px-8 lg:px-12 py-8 lg:py-16 relative" data-aos="fade-right" data-aos-duration="300" data-aos-easing="ease-out"
      >
        ...
        <div className="relative w-full max-w-lg">
          {isSafari ? (
            <img
              ...
              className="w-full h-[28rem] object-cover rounded-full relative z-10 shadow-2xl hover-scale shadow-blue-500" data-aos="fade-in" data-aos-duration="300"
            />
          ) : (
            <video
              autoPlay
          ...
          {/* Glow Effect */}
          <div
            className="absolute -inset-4 blur-2xl pulse-effect -z-10" data-aos="fade-in" data-aos-duration="1000"
          />
        </div>
      </div>
    </div>
