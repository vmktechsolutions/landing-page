  ...
  return (
    <div className="flex-shrink-0 w-80 my-5 group">
      <div
        ...
        className="h-full rounded-custom overflow-hidden bg-white border border-gray-200 shadow-lg transform-gpu will-change-transform transition-transform duration-200 hover:scale-[1.02]" className="your-class"
        data-aos="fade-up"
        ...
        <div className="p-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="bg-greenColor text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-opacity-90 transition-colors hidden transform-gpu" data-aos="zoom-in"
  ...
  return (
    <div className='bg-white min-h-screen py-16 px-4 md:px-16'>
      <div
        ...
        className="text-center mb-12 transform-gpu" data-aos="fade-up"
        data-aos-duration="500"
